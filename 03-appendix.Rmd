...
The discussion below is therefore framed with respect to the 2010 decennial census; if you choose to use another census dataset to create the index, your code may look slightly different. 
...
Then, we create a new variable named "total_black_pop_over17", which is defined be subtracting the total Black population that is 17 and under from the total Black population:
