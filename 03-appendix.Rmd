...
co_counties_race<-as.tibble(co_counties_race)
...
co_counties_race_census_dataset<-co_counties_race %>% select(GEOID, County, total_pop, total_black_pop_over17, 
                                              total_pop_over17)
```


```{r}
co_counties_race_census_dataset
```
