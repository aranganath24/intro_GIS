...
* A spatial dataset of Colorado counties, available from the US census via the [Colorado GeoLibrary](https://geo.colorado.edu/), a curated online archive of Colorado-related spatial data. The specific dataset we will use is available [here](https://geo.colorado.edu/catalog/47540-5e712aeda3d91e0009f59fc7). Note that this spatial dataset is stored as a shapefile, which is a common file format used to store spatial data. 
